...
RSpec.describe 'Questions', type: :request do
  ...
  describe 'GET /quiz' do
    ...
    it '全問出題済みの場合は結果画面にリダイレクトされる' do
      ...
      # 1問目正解
      post check_answer_path,
           params: { question_id: question1.id, choice_id: create(:choice, question: question1, is_correct: true).id }
      # 2問目正解
      post check_answer_path,
           params: { question_id: question2.id, choice_id: create(:choice, question: question2, is_correct: true).id }
