...
<img width="1170" height="535" alt="スクリーンショット 2026-03-02 8 21 08" src="https://github.com/user-attachments/assets/b0e250ea-5b2b-4bcf-9ac2-3d450bf8d00b" />

## 概要
本アプリは、「麟」という漢字に関するクイズに挑戦し、他ユーザーとスコアを競い合えるWebアプリです。
スコアに応じて称号やシンボルを獲得でき、ランキング機能も実装しています。  
